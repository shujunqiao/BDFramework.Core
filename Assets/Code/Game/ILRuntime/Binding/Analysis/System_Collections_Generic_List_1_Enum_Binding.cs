...
{
    unsafe class System_Collections_Generic_List_1_Enum_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<System.Enum>);
            args = new Type[]{};
        ...
        static StackObject* get_Count_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<System.Enum> instance_of_this_method = (System.Collections.Generic.List<System.Enum>)typeof(System.Collections.Generic.List<System.Enum>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
